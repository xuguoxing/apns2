...
type Notification struct {
	...
	// The channel ID is a base64-encoded string that identifies the channel to
	// publish the payload. The channel ID is generated by sending channel
	// creation request to APNs.
	ChannelID string
}
